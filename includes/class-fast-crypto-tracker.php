...
class Fast_Crypto_Tracker {
    ...
    private function define_public_hooks() {
        ...
        // --- NEW LINE: Register the Shortcode ---
        // Tells WP: When [crypto_price] is found, run get_crypto_price_shortcode()
        $this->loader->add_shortcode( 'crypto_price', $plugin_public, 'get_crypto_price_shortcode' );
